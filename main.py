...
# --- Logging para Telegram de alertas ---
...
status_map       = {}    # aid → info dict for SMS flows
PENDING_RECHARGE = {}    # user_id → True when awaiting amount input
PRAZO_MINUTOS    = 23
PRAZO_SEGUNDOS   = PRAZO_MINUTOS * 60

# === AUXILIARES PARA USUÁRIOS ===
